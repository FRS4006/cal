...
urlpatterns = [
    ...
    path('next_week/<int:next_month>/<int:selected_month>/<int:selected_year>/<int:next_week>/<int:selected_week>/<int:sixth_week>', displayViews.next_week, name='next_week'),
